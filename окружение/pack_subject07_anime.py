"""Pack Subject 07 clean anime VN sprites into a separate magenta folder."""
...
ITEMS = [
    ("subject07_anime_front.png", "front"),
    ("subject07_anime_back.png", "back"),
    ("subject07_anime_threequarter.png", "3/4"),
    ("subject07_anime_side.png", "side"),
    ("subject07_anime_paper.png", "paper"),
    ("subject07_anime_injured.png", "injured"),
]
...
def main() -> None:
    ...
    sheet = catalog(pairs)
    sheet.save(DST / "subject07_anime_sheet_blocks.png", optimize=True)
    sheet.save(m.OUT / "subject07_anime_sheet_blocks.png", optimize=True)
