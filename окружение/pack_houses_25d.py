"""Pack 2.5D houses onto magenta, separate folder like trees."""
...
def main() -> None:
    ...
    for i, (crop, mag_c) in enumerate(crops, start=1):
        ...
        out = DST / f"house_25d_{i:02d}.png"
        im.save(out, optimize=True)
        tiles.append(im)
        print("saved", out.name)

    sheet = catalog(tiles)
    sheet.save(DST / "houses_25d_sheet_blocks.png", optimize=True)
    sheet.save(m.OUT / "houses_25d_sheet_blocks.png", optimize=True)
