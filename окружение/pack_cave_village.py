"""Pack Fear & Hunger cave-village props onto magenta."""
...
ITEMS = [
    ("cave_hut_01.png", "hut 1"),
    ("cave_hut_02.png", "hut 2"),
    ("cave_hut_03.png", "hut 3"),
    ("cave_hut_04.png", "hut 4"),
    ("cave_fence_logs.png", "fence logs"),
    ("cave_fence_rail.png", "fence rail"),
    ("cave_platform.png", "platform"),
    ("cave_ladder.png", "ladder"),
    ("cave_hoist.png", "hoist"),
    ("cave_barrel.png", "barrel"),
    ("cave_crate.png", "crate"),
    ("cave_pots.png", "pots"),
    ("cave_torch.png", "torch"),
    ("cave_rug.png", "rug"),
    ("cave_stool.png", "stool"),
    ("cave_bones.png", "bones"),
]
...
def main() -> None:
    ...
    for src_name, label in ITEMS:
        ...
        slug = Path(src_name).stem
        im.save(DST / f"{slug}.png", optimize=True)
        pairs.append((label, im))
        print("saved", slug, crop.shape[1], crop.shape[0])

    sheet = catalog(pairs)
    sheet.save(DST / "cave_village_sheet_blocks.png", optimize=True)
    sheet.save(m.OUT / "cave_village_sheet_blocks.png", optimize=True)
